...
let routes = [
    ...
    { path: '/earningsdetails/:userId', component: require('./components/Earningsdetails.vue').default },
    { path: '/revision/:orderId', component: require('./components/Revisions.vue').default},
    { path: '/disputes/:orderId', component: require('./components/disputes.vue').default},
    { path: '/extension/:orderId', component: require('./components/Extension.vue').default},
];
