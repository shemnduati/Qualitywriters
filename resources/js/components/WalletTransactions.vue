                        ...
                        <table class="table table-hover">
                            ...
                            <tr v-for="trans in transactions.data" :key="trans.id">
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-pill badge-danger" v-if="trans.type == 6">Cancelled</span>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-dark btn-sm" v-if="trans.type == 5" @click="reasonModal(trans.description)">Details</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
