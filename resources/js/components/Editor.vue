    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">Uploaded Orders</div>

                    <div class="card-body">
                        <h3>New Uploaded Orders</h3>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Order Details<span class="badge badge-dark"
                                                                              ...
                                                                              v-if="details.urgency == 1">Urgent</span>
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                                ...
                                                <div class="box-body" v-if="this.filesCount > 0">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-xs-12" v-for="file in files"
                                                             :key="file.id">
                                                            <a @click.prevent="download(file.id, file.path)" style="cursor: pointer">
                                                                <div class="info-box">
...
<script>
    export default {
        ...
        methods: {
            ...
            checkBid() {
                axios.get("api/editorCheckbid/" + this.orderId).then(({data}) => ([this.ifBid = data]));
            },
            placeBid() {
                Swal.fire({
                    title: 'Are you sure?',
            ...
            getOrders() {
                window.axios.get("api/editorOrders").then(({data}) => ([this.orders = data.data]));
            },
        },
        created() {
            this.getLevel();
