                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-sm-4 border-right">
                                    <router-link :to="{path:'/writerdetails/'+ user['id']}" class="btn btn-light info-box-number">
                                ...
                                <!-- /.col -->
                                <div class="col-sm-4 border-right">
                                    <router-link :to="{path:'/writerdetails/'+ user['id']}" type="button" class="btn btn-light info-box-number">
                                    <div class="description-block">
...
<script>
    export default {
        ...
        methods: {
            getResults(page = 1) {
                axios.get('api/MyWriters?page=' + page)
                    .then(response => {
